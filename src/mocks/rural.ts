...
export const imoveisRurais: ImovelRural[] = [
  {
    ...
    ccir: "3.101.204-9",
    itr: "regular",
    matricula: "44.221 · CRI Nova Mutum",
    benfeitorias: "Sede, 4 galpões, 12 casas",
    aguas: "Rio + 3 açudes",
    acesso: "BR-163 · 8 km asfalto",
    reservaLegalHa: 480,
    appHa: 180,
    produtivaHa: 1740,
    valorTotal: 168000000,
    valorHectare: 70000,
    proprietario: "Grupo Bela Vista",
    captadoPor: "Diego",
    cover: covers[0],
    destaque: true,
  },
  {
    ...
    ccir: "3.201.884-2",
    itr: "regular",
    matricula: "18.994 · CRI Sorriso",
    benfeitorias: "Sede, 2 armazéns 20k sc",
    aguas: "Rio Teles Pires · nascentes",
    acesso: "MT-242 · 3 km cascalho",
    reservaLegalHa: 260,
    appHa: 90,
    produtivaHa: 830,
    valorTotal: 89000000,
    valorHectare: 75000,
    proprietario: "Família Menezes",
    captadoPor: "Marcos",
    cover: covers[1],
    destaque: true,
  },
  {
    ...
    ccir: "3.011.502-1",
    itr: "regular",
    matricula: "8.221 · CRI Chapada",
    benfeitorias: "Sede pé-direito duplo, piscina",
    aguas: "2 nascentes · córrego",
    acesso: "MT-251 · asfalto até o portão",
    reservaLegalHa: 3,
    appHa: 2,
    produtivaHa: 10,
    valorTotal: 890000,
    valorHectare: 59333,
    proprietario: "Fernanda Prado",
    captadoPor: "Larissa",
    cover: covers[2],
    destaque: false,
  },
  {
    ...
    ccir: "3.407.221-8",
    itr: "pendente",
    matricula: "22.104 · CRI Poconé",
    benfeitorias: "Sede, curral, 6 mangueiras",
    aguas: "Rio Cuiabá · baías",
    acesso: "Transpantaneira · 12 km",
    reservaLegalHa: 1280,
    appHa: 420,
    produtivaHa: 1500,
    valorTotal: 44000000,
    valorHectare: 13750,
    proprietario: "Pantanal Agro",
    captadoPor: "Diego",
    cover: covers[3],
    destaque: true,
  },
  {
    ...
    ccir: "3.310.995-4",
    itr: "regular",
    matricula: "31.402 · CRI Primavera",
    benfeitorias: "Sede, secador 500 sc/h",
    aguas: "Ribeirão + poços",
    acesso: "BR-070 · 2 km asfalto",
    reservaLegalHa: 380,
    appHa: 140,
    produtivaHa: 1280,
    valorTotal: 126000000,
    valorHectare: 70000,
    proprietario: "Agro Cerrado LTDA",
    captadoPor: "Marcos",
    cover: covers[4],
    destaque: false,
  },
  {
    ...
    ccir: "3.508.331-2",
    itr: "atrasado",
    matricula: "12.887 · CRI Rondonópolis",
    benfeitorias: "Casa caseiro, viveiro mudas",
    aguas: "Nascente + córrego",
    acesso: "MT-270 · 5 km cascalho",
    reservaLegalHa: 9,
    appHa: 6,
    produtivaHa: 27,
    valorTotal: 1600000,
    valorHectare: 38095,
    proprietario: "Sérgio Bittencourt",
    captadoPor: "Larissa",
    cover: covers[5],
    destaque: false,
  },
  {
    ...
    ccir: "3.902.114-6",
    itr: "regular",
    matricula: "58.221 · CRI Campo Novo",
    benfeitorias: "2 sedes, 3 armazéns 60k sc",
    aguas: "Rio + 5 açudes",
    acesso: "BR-364 · asfalto",
    reservaLegalHa: 890,
    appHa: 320,
    produtivaHa: 2990,
    valorTotal: 310000000,
    valorHectare: 73810,
    proprietario: "Três Rios Agro",
    captadoPor: "Diego",
    cover: covers[0],
    destaque: true,
  },
  {
    ...
    ccir: "3.605.998-1",
    itr: "regular",
    matricula: "14.502 · CRI Cáceres",
    benfeitorias: "Sede, curral novo, 3 casas",
    aguas: "Rio Paraguai · nascentes",
    acesso: "MT-343 · 4 km cascalho",
    reservaLegalHa: 150,
    appHa: 60,
    produtivaHa: 470,
    valorTotal: 16000000,
    valorHectare: 23529,
    proprietario: "Herdeiros Pouso",
    captadoPor: "Marcos",
    cover: covers[3],
    destaque: false,
  },
...
export const passivosAmbientais = [
  {
    id: 1,
    imovel: "IMR-2204 · Pantanal do Rio",
    tipo: "APP degradada",
    areaHa: 12,
    prazo: "12/2027",
  ...
  {
    id: 2,
    imovel: "IMR-2201 · Boa Vista",
    tipo: "Reserva legal a averbar",
    areaHa: 40,
    prazo: "06/2027",
  ...
  {
    id: 3,
    imovel: "IMR-2206 · Sítio das Águas",
    tipo: "ITR em atraso",
    areaHa: 0,
    prazo: "imediato",
    severidade: "alta" as const,
  ...
  {
    id: 4,
    imovel: "IMR-2208 · Pouso Alegre",
    tipo: "CAR pendente análise",
    areaHa: 0,
    prazo: "análise",
