...
export const Route = createFileRoute("/app/configurar-site")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Identidade visual, domínio, layout e SEO do portal público.",
      },
    ],
  }),
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-medium">Paleta de cores</h2>
          </div>
        ...
        <section className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-medium">SEO & fonte</h2>
          </div>
          <div className="mt-4 space-y-3 text-sm">
            <div>
            ...
            <div>
              ...
              <textarea
                rows={3}
                defaultValue="Encontre imóveis para comprar, alugar e investir em Cuiabá e região com atendimento humano e ferramentas inteligentes."
