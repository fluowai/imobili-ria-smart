...
export const Route = createFileRoute("/app/landing-pages")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Landing pages de campanha com métricas de tráfego, leads e CPL.",
      },
    ],
  }),
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        <Kpi
          label="Landings ativas"
          valor={landings.filter((l) => l.status === "publicada").length}
        />
        <Kpi
          label="Leads gerados"
            ...
            <div className="p-5">
              ...
              <div className="mt-4 flex items-center justify-between border-t border-border pt-3">
                <span className="text-xs text-muted-foreground">
                  Investido: {fmtBRLFull(l.investimento)}
                </span>
