...
export const Route = createFileRoute("/app/editor")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Editor drag-and-drop para páginas do site e landing pages.",
      },
    ],
  }),
      ...
      <div className="grid gap-4 lg:grid-cols-[220px_1fr_260px]">
        <aside className="rounded-xl border border-border bg-card p-4 h-fit">
            ...
            {blocosDisponiveis.map((b) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg border border-border bg-background p-2 text-sm hover:border-primary hover:bg-muted"
                >
          ...
          <p className="mt-4 text-[11px] text-muted-foreground">
            Clique num bloco para adicionar ao canvas.
          </p>
        </aside>
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex gap-1">
              <button className="rounded-md border border-input bg-background px-2 py-0.5 text-[10px]">
                Desktop
              </button>
              <button className="rounded-md border border-input bg-muted px-2 py-0.5 text-[10px]">
                Mobile
              </button>
            </div>
          </div>
          ...
          {sel ? (
            <div className="mt-3 space-y-3 text-sm">
              <div>
                ...
                <input
                  defaultValue="Encontre seu novo lar"
