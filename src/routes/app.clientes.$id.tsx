...
export const Route = createFileRoute("/app/clientes/$id")({
  head: () => ({
    meta: [{ title: "Detalhes do Cliente — ImobiOS" }],
  }),
...
function ClienteDetailsPage() {
  ...
  if (isLoading)
    return <div className="p-8 text-center text-muted-foreground">Carregando cliente...</div>;
  if (!cliente)
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button
                className="w-full"
                variant="outline"
                onClick={() => (window.location.href = `mailto:${cliente.email}`)}
