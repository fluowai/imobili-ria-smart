...
export const Route = createFileRoute("/app/urbano/condominios")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Administração de condomínios: unidades, síndico, taxas e inadimplência.",
      },
    ],
  }),
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 grid grid-cols-3 gap-2 text-xs">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>{c.unidades} unid.</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Users className="h-3.5 w-3.5 text-muted-foreground" />
                  <span className="truncate">{c.sindico}</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <AlertCircle className="h-3.5 w-3.5 text-muted-foreground" />
                  <span>{c.inadimplencia}% inad.</span>
                </div>
              </div>
